...
int main (int argc, const char * argv[])
{
	...
	IplImage *img_happy = cvLoadImage("C:/Users/exdyd/Downloads/smiledetector/data/happy.jpg");
	IplImage *img_sad = cvLoadImage("C:/Users/exdyd/Downloads/smiledetector/data/sad.jpg");
	
	// read the images size
	CvSize sz = cvGetSize(cvLoadImage("C:/Users/exdyd/Downloads/smiledetector/data/happy00.png"));
	...
	for(int i = 0; i < M/2; i++)
	{
		sprintf(file, "C:/Users/exdyd/Downloads/smiledetector/data/happy%02d.png", i);
	...
	for(int i = 0; i < M/2; i++)
	{
		sprintf(file, "C:/Users/exdyd/Downloads/smiledetector/data/sad%02d.png", i);
		Mat m = cvLoadImageM(file, CV_LOAD_IMAGE_GRAYSCALE);
		m = m.t();
		m = m.reshape(1, N);
		m.convertTo(m, CV_32FC1);
	...
	CvHaarClassifierCascade *cascade = (CvHaarClassifierCascade*)cvLoad("C:/Users/exdyd/Downloads/smiledetector/data/haarcascade_frontalface_default.xml");
	...
	while(1) 
	{
		...
		switch(c) // capture a frame when H (happy) or S (sad) is pressed
		{
			char file[32];
			case 'h':
				sprintf(file, "C:/Users/exdyd/Downloads/smiledetector/data/happy%02d.png", happy_count);
				cvSaveImage(file, subimg_gray);
				happy_count++;
				cvWaitKey(1000);
				break;
			case 's':
				sprintf(file, "C:/Users/exdyd/Downloads/smiledetector/data/sad%02d.png", sad_count);
				cvSaveImage(file, subimg_gray);
				sad_count++;
				cvWaitKey(1000);
				break;
